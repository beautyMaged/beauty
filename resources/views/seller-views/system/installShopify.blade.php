...
<style>
    .salla-btn {
        background-color: rgb(94, 142, 62);
        color: white;
    }
                    ...
                    <div class="card card-lg mb-5">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center">
                                <svg style="width: 15rem;margin: 2rem;"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 608 173.7" role="img">
                                    <title>Shopify</title>
                                    <path fill="#95BF47"
                                ...
                                <a href="{{ route('seller.shopify.oauth.redirect') }}"
                                    class="btn btn-lg btn-block salla-btn">{{ \App\CPU\translate('install_shopify') }}</a>
                            </div>
                        </div>
                    </div>
                    <!-- End Card -->
