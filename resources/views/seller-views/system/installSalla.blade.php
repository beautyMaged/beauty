                        ...
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center">
                                <img class="m-4 p-4 w-50"
                                    src="https://apps.salla.sa/assets/salla-logo-wide.2b195378.svg" alt="Salla">
                                <a href="{{route('seller.salla.oauth.redirect')}}"
                                    class="btn btn-lg btn-block salla-btn">{{ \App\CPU\translate('install_salla') }}</a>
                            </div>
                        </div>
                    </div>
                    <!-- End Card -->
