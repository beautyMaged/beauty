            ...
            <div class="col-lg-4 col-xxl-3 d-flex flex-column gap-3">
                <div class="card">
                    <div class="card-body text-capitalize d-flex flex-column gap-4">
                        ...
                        @if (
                            ($order['payment_method'] == 'cash_on_delivery' || $order['payment_method'] == 'offline_payment') &&
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-column gap-2">
                                    <div>
                                        ...
                                        <strong>{{ isset($shipping_address->contact_person_name) ? $shipping_address->contact_person_name : '' }}</strong>
                                    </div>
                                    <div>
                                        <span>{{ \App\CPU\translate('Contact') }}:</span>
                                        <strong>{{ isset($shipping_address->phone) ? $shipping_address->phone : '' }}</strong>
                                    </div>
                                    <div>
                                        <span>{{ \App\CPU\translate('City') }}:</span>
                                        <strong>{{ isset($shipping_address->city) ?: '' }}</strong>
                                    </div>
                                    <div>
                                        <span>{{ \App\CPU\translate('zip_code') }} :</span>
                                        <strong>{{ isset($shipping_address->zip) ? $shipping_address->zip : '' }}</strong>
                                    </div>
                    ...
                    @if ($order->customer)
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-column gap-2">
                                ...
                                <div>
                                    <span>{{ \App\CPU\translate('zip_code') }} :</span>
                                    <strong>{{ isset($billing->zip) ? $billing->zip : '' }}</strong>
                                </div>
                                <div class="d-flex align-items-start gap-2">
                        ...
                        <div class="media">
                            <div class="mr-3">
                                <img class="avatar rounded avatar-70"
                                    onerror="this.onerror=null;this.src='https://6valley.6amtech.com/public/assets/front-end/img/image-place-holder.png'"
...
@push('script')
    ...
    <script>
        function initializegLocationMap() {
            var map = null;
            var myLatlng = new google.maps.LatLng({{ isset($shipping_address->latitude) ? $shipping_address->latitude : null }},
            ...
            @if ($shipping_address && isset($shipping_address))
                var marker = new google.maps.Marker({
                    position: new google.maps.LatLng({{ isset($shipping_address->latitude) ? $shipping_address->latitude : null }},
                        {{ isset($shipping_address->longitude) ? $shipping_address->longitude : null}}),
                    map: map,
