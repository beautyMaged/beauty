    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 d-flex gap-2">
                ...
                {{ \App\CPU\translate('Sub') }} {{ \App\CPU\translate('Sub') }} {{ \App\CPU\translate('Sub') }}
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body" style="text-align: {{ Session::get('direction') === 'rtl' ? 'right' : 'left' }};">
                        <form action="{{ route('admin.sub-sub-sub-category.store') }}" enctype="multipart/form-data"
                            method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                <label class="title-color text-capitalize"
                                    ...
                                    {{ \App\CPU\translate('name') }}
                                    <span class="text-danger">*</span></label>
                                <select name="mid_parent_id" id="parent_id" class="form-control">

                                </select>
                            </div>
                            <div class="form-group">
                                <label class="title-color text-capitalize"
                                    for="name">{{ \App\CPU\translate('Sub_Sub_Sub_Categories') }}
                                    {{ \App\CPU\translate('name') }}
                                    <span class="text-danger">*</span></label>
                            ...
                            <div class="from_part_2">
                                ...
                                <div class="custom-file text-left">
                                    ...
                                    <label class="custom-file-label" for="customFileEg1">{{ \App\CPU\translate('choose') }}
        ...
        $(document).on('click', '.delete', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "{{ route('admin.sub-sub-sub-category.delete') }}",
                        method: 'POST',
                        data: {
                            id: id
                        },
