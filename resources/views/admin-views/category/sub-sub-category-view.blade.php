            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body"
                        ...
                        <form action="{{route('admin.sub-sub-category.store')}}" enctype="multipart/form-data" method="POST">
                            @csrf
                                ...
                                <div class="row">
                                    ...
                                    @else
                                            <div class="form-group lang_form" id="{{$default_lang}}-form">
                                                <label
                                                    class="title-color">{{\App\CPU\translate('Sub_sub_category')}} {{\App\CPU\translate('name')}}
                                                    <span class="text-danger">*</span>
                                                    ({{strtoupper($lang)}})</label>
                                                <input type="text" name="name[]" class="form-control"
                                    ...
                                    @endif
                                        ...
                                        <div class="form-group">
                                            <label class="title-color text-capitalize"
                                                   for="name">{{\App\CPU\translate('sub_category')}} {{\App\CPU\translate('name')}}
                                                <span class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="priority" id="" required>
                                                <option disabled
                                                        selected>{{\App\CPU\translate('Set_Priority')}}</option>
                                                @for ($i = 0; $i <= 10; $i++)
                                                    <option
                                                        value="{{$i}}">{{$i}}</option>
                                                @endfor
