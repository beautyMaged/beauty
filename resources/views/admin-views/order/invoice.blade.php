    ...
    <table class="bs-0 mb-30 px-10">
        <tr>
            ...
            <th class="content-position-y text-right">
                <h4 class="fz-14">{{\App\CPU\translate('date')}}
                    : {{date('d-m-Y h:i:s a',strtotime($order['created_at']))}}</h4>
            </th>
        </tr>
    </table>
</div>
                        ...
                        <tr>
                            <td>
                                ...
                                <div class="h4 montserrat-normal-600">
                                    <p style=" margin-top: 6px; margin-bottom:0px;">{{$data["client_name"]}}</p>
                                    <p style=" margin-top: 6px; margin-bottom:0px;">{{$data["email"]}}</p>
                                    <p style=" margin-top: 6px; margin-bottom:0px;">{{$data["phone"]}}</p>
                                    <p style=" margin-top: 6px; margin-bottom:0px;">{{$data["address"]}}</p>
                                </div>
                            </td>
                        </tr>
                    </table>
        ...
        <tr>
            ...
            <th>
                <table class="calc-table">
                    ...
                    <tr>
                        <td class="border-dashed-top font-weight-bold text-left"><b>{{\App\CPU\translate('total')}}</b>
                        </td>
        ...
        <table class="">
            <tr>
                <th class="fz-12 font-normal pb-3">
                    {{\App\CPU\translate('If_you_require_any_assistance_or_have_feedback_or_suggestions_about_our_site,_you')}}
                    <br/> {{\App\CPU\translate('can_email_us_at')}} <a
