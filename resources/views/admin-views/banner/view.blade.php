                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="js-example-responsive form-control w-100 banner_type"
...
{{--                                            <option value="brand">{{ \App\CPU\translate('Brand')}}</option>--}}
                                    ...
                                    <div class="form-group main_title_div">
                                        <label for="main_title"
                                               class="title-color text-capitalize">{{ \App\CPU\translate('main title')}}</label>
                                    ...
                                    <div>
                                            ...
                                            <center class="mb-30 mx-auto  rat_3_5_1">
                                                <img
                                                    class="ratio-3.5:1"
                                                    id="mbImageviewer"
                                                    src="{{asset('assets/front-end/img/3.5-1.png')}}"
                                                    alt="banner image"/>
                                            </center>
                                        <center class="mb-30 mx-auto rat_2_1">
                                            <img class="ratio-2:1" id="mbImageviewer"
                                                src="{{asset('assets/front-end/img/2-1.png')}}"
                                                alt="banner image"/>
                                        </center>
                                        <label for="name" class="title-color text-capitalize">{{ \App\CPU\translate('Image')}}</label>
                                        <span class="text-info rat_4_1">( {{\App\CPU\translate('ratio')}} 4:1 )</span>
                                        <span class="text-info  rat_2_1">( {{\App\CPU\translate('ratio')}} 2:1 )</span>
                                        <span class="text-info  rat_3_5_1">( {{\App\CPU\translate('ratio')}} 2:1 )</span>
