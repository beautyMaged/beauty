...
@section('content')
    @php
        if(isset($_GET['id']) && $_GET['data_from'] == 'brand') {$brand_name =\App\Model\Brand::find($_GET['id'])->name;}
    ...
    <div class="container pb-5 mb-2 mb-md-4 rtl __inline-35"
        ...
        <div class="row" dir="rtl">
            <div class="col-12 mb-2 open_filter">
                <img src="{{asset('assets/front-end/img/filter.png')}}" alt="filter" width="30">
            </div>
            <!-- Sidebar-->
            <aside
                class="col-lg-3 hidden-xs col-md-3 col-sm-4 mt-5 pt-5 pl-4 SearchParameters __search-sidebar {{Session::get('direction') === "rtl" ? 'pl-2' : 'pr-2'}}"
                    ...
                    <div class="pb-0">
                        ...
                        <div class="text-right">
                            ...
                            <div class="__cate-side-title  pr-4 border-bottom"
                                ...
                                <span class="widget-title s_18 font-semibold">فلترة البحث</span>
                            </div>


                            <div class="__cate-side-sub-title  pr-4 border-bottom"
                                 style="">
                                <span class="widget-title s_18 font-semibold">نوع الفلتر</span>
                            </div>
                            @if(isset($_GET['id']))
                                <div class=" custom_custom_check"
                                     style="  width: 100%">
                                    <div class="pretty p-svg p-curve mt-3 w-100">
                                        <input type="radio" name="filter_type"
                                        ...
                                        <div class="state p-success" style="padding-right: 17px">
                                            ...
                                            <label class="bold" for="latest">وصل حديثاً</label>
                                        </div>
                                    </div>
                                </div>
                                <div class=" custom_custom_check"
                                    ...
                                    <div class="pretty p-svg p-curve mt-3 w-100">
                                        ...
                                        <div class="state p-success" style="padding-right: 17px">
                                            ...
                                            <label class="bold" for="best_sell">الأكثر مبيعاً</label>
                                        </div>
                                    </div>
                                </div>
                                <div class=" custom_custom_check"
                                    ...
                                    <div class="pretty p-svg p-curve mt-3 w-100">
                                        ...
                                        <div class="state p-success" style="padding-right: 17px">
                                            ...
                                            <label class="bold" for="top_rate">الأعلي تقييماً</label>
                                        </div>
                                    </div>
                                </div>
                                <div class=" custom_custom_check"
                                    ...
                                    <div class="pretty p-svg p-curve mt-3 w-100">
                                        ...
                                        <div class="state p-success" style="padding-right: 17px">
                                            ...
                                            <label class="bold" for="featured_deal">العروض الخاصة</label>
                                        </div>
                                    </div>
                                </div>
                            @else
                            ...
                            <div class="__cate-side-sub-title  pr-4 border-bottom"
                                 style="">
                                <span class="widget-title s_18 font-semibold">السعر</span>
                            </div>
                            ...
                            <div class="__cate-side-sub-title  pr-4 border-bottom"
                                 style="border-bottom: 1px solid #f8a2bf!important;">
                                <span class="widget-title s_18 font-semibold">الفئة</span>
                            </div>
                                    ...
                                    <div
                                        ...
                                        <div class="sub_menu mt-3">
                                            <ul id="list" class="row"
                                                    ...
                                                    <li class="locations col-xxl-12 col-xl-12 col-md-12 col-sm-12 col-12  mx-0 px-2 position-relative">
                                                        ...
                                                        <div>
                                                            <div class="card-header p-1 flex-between">
                                                                <div>
                                                                    <label class="for-hover-lable cursor-pointer bold"
                                                ...
                                                {{--                                                                <i class="fa fa-chevron-down d-none"></i>--}}
                                                {{--                                                            </span>--}}
                                                {{--                                                                <ul class="cities sub_from_main" style="padding-left: 0!important;padding-right: 20px;margin-top: 2px;list-style:none;display: none">--}}
                            ...
                            <div class="__cate-side-sub-title  pr-4 border-bottom"
                                 style="border-bottom: 1px solid #f8a2bf!important;">
                                <span class="widget-title s_18 font-semibold">براند</span>
                            </div>
                            ...
                            <div class="__cate-side-sub-title  pr-4 border-bottom"
                                 style="border-bottom: 1px solid #f8a2bf!important;">
                                <span class="widget-title s_18 font-semibold">اللون</span>
                            </div>
                            @php($colors = App\Model\Color::get())
                            @if(isset($_GET['id']))
                    ...
                    <div class="row">
                        <div class="owl-carousel owl-theme footer_cat_banners" dir="ltr">
                            ...
                            @if($category_banners->position == 0)
                                @php($banners = $category_banners->banners->where('banner_type', 'Footer Banner'))
                            @elseif($category_banners->position == 1)
                                @php($banners = $category_banners->parent->banners->where('banner_type', 'Footer Banner'))
                            @else
                                @php($banners = $category_banners->parent->parent->banners->where('banner_type', 'Footer Banner'))
                            @endif
                                        ...
                                        <div class="col-xxl-12 col-xl-12 col-md-12 col-sm-12 col-12 my-2">
                                            <div class="large-offer">
                                                ...
                                                <div class="offer-title">
                                                    ...
                                                    <a href="{{$banner->url}}" class="btn btn-sm btn-custom bold">تسوق
                                                        الآن</a>
                                                </div>
                                            </div>
