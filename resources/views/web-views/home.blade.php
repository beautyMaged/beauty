...
@section('content')
    ...
    <!-- Hero (Banners + Slider)-->
        ...
        @if(isset($main_cats) && $main_cats->count() > 0)
            <section class="featured_subs mt-5" dir="rtl">
                <div class="container" style="">
                    <div class="row">
                        <div class="col-xxl-12 col-xl-12 col-md-12 col-sm-12 col-12">
                            <h4 class="main_title  bold s_25 mt-5 {{session('direction') == 'rtl' ? 'mr-5 text-right' : 'ml-5 text-left'}}">
                                {{\App\CPU\translate('main_cats')}}
                            </h4>
                        </div>
                        <div class="col-xxl-11 col-xl-11 col-md-11 col-sm-12 col-12 m-auto pt-3">
                            <div class="owl-carousel owl-theme featured_cats mains" dir="ltr">
                                @foreach($main_cats as $main_cat)
                                    <div class=" featured_sub_cat m-auto text-center">
                                        <a href="{{route('home')}}/products?id={{$main_cat->id}}&data_from=category&page=1"
                                           class="w-100">
                                            <img src="{{asset('storage/category/'. $main_cat->icon)}}" alt="">
                                            <h5 class="mt-3 bold sub_cat_head primary_color">{{$main_cat->name}}
                                            </h5>
                                        </a>
                                    </div>
                                @endforeach
        ...
        <section class="price_filter_home mt-5 px-5 py-3"
                 style="background-image: url('{{asset('uploads/budget_filter/' . $budget_filter->bg)}}'); background-size: 100% 100%">
            <div class="row">
                <div class="col-lg-9 col-md-9 col-12 m-auto p-4">
                    <div class="row text-center">
                        <div class="col-12 col-lg-12 col-md-12">
                            <h4 class="primary_color bold s_20 mb-4">
                                {{\App\CPU\translate('but_according')}}
                            </h4>
                        </div>
                        <div class="col-lg-3 col-md-3 col-6 mb-2">
                            <div class="single_price_item position-relative"
                                 data-value="{{route('products', ['data_from' => 'latest', 'page' => '1', 'max' => $budget_filter->f_num])}}">
                                <h4 class="num_fam bold s_20">{{$budget_filter->f_num}}</h4>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-6  mb-2">
                            <div class="single_price_item position-relative"
                                 data-value="{{route('products', ['data_from' => 'latest', 'page' => '1', 'max' => $budget_filter->s_num])}}">
                                <h4 class="num_fam bold s_20">{{$budget_filter->s_num}}</h4>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-6  mb-2">
                            <div class="single_price_item position-relative"
                                 data-value="{{route('products', ['data_from' => 'latest', 'page' => '1', 'max' => $budget_filter->t_num])}}">
                                <h4 class="num_fam bold s_20">{{$budget_filter->t_num}}</h4>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-6  mb-2">
                            <div class="single_price_item position-relative"
                                 data-value="{{route('products', ['data_from' => 'latest', 'page' => '1', 'max' => $budget_filter->fo_num])}}">
                                <h4 class="num_fam bold s_20">{{$budget_filter->fo_num}}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="sorting_div s_12 bold" dir="ltr">
                                <div class="w-100 text-right">
                                            <span class="bold sort-span"
                                                  dir="rtl">{{\App\CPU\translate('sort_by')}} : <span>{{\App\CPU\translate('Most Favourit')}}</span> &nbsp;&nbsp;<i
                            ...
                            <div class="col-xxl-12 col-xl-12 col-md-12 col-sm-12 col-12 m-auto pt-0">
                                <div class="row slider_products_row" style="height: 800px">
                                    <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-12">
                                        <div class="owl-carousel owl-theme products_carousel_container" dir="ltr">
                                            @foreach($latest_products as $k => $one_chunk)
                                                ...
                                                <div class="row slider_products_item" style="height: 803px"
                                                     dir="{{session('direction') == 'rtl' ? 'ltr' : 'rtl'}}">


                                                    <div
                                                        class="col-xxl-5 col-xl-5 col-md-5 col-sm-11 col-12 m-auto   large-featured-product text-center"
                                                        style="    height:97%;">
                                                ...
                                                border-radius: 10px;margin-bottom: 5px">
                                                            ...
                                                            <div
                                                                ...
                                                                @if(count(json_decode($one_chunk[$k]->colors)) > 0)
                                                                    @foreach(json_decode($one_chunk[$k]->color_image) as $k_img => $large_image)
                                                                        <img
                                                                            src="{{asset('storage/product/' . $large_image->image_name)}}"
                                                                            alt="product"
                                                                ...
                                                                @else
                                                                    <img
                                                                        src="{{asset('storage/product/thumbnail/' . $one_chunk[$k]->thumbnail)}}"
                                                            ...
                                                            <div class="col-lg-12 col-md-12">
                                                                <a href="{{route('product', $one_chunk[$k]->slug)}}"><h4
                                                                        class="s_27 primary_color bold">
                                                                        {{$one_chunk[$k]->name}}
                                                                    </h4></a>
                                                            </div>
                                            ...
                                            {{\App\CPU\Helpers::currency_converter($one_chunk[$k]->unit_price-(\App\CPU\Helpers::get_product_discount($one_chunk[$k],$one_chunk[$k]->unit_price)))}}
                                                            ...
                                                            <div class="mt11 col-lg-12 col-md-12">
                                                                <ul class="list-inline checkbox-color mb-1 flex-start ml-2"
                                                                    style="padding-left: 0;min-height:37px;" dir="ltr">
                                                                    @if(count(json_decode($one_chunk[$k]->colors)) > 0)
                                                                        ...
                                                                        @foreach(json_decode($one_chunk[$k]->colors) as $k_img => $large_image)
                                                                            <li>
                                                                                <input type="radio"
                                                                                       ...
                                                                                       checked="">
                                                                                <label
                                                                                    style="background: {{$large_image}}; margin-bottom: 0!important;"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class=" row">
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    @else
                                                                                        <img
                                                                                            src="{{asset('storage/product/thumbnail/' . $small_product->thumbnail)}}"
                                                                                            alt="product"
                                                                                            style="height:100%"
                                                                                            class="w-100 px-1 pt-2 product_image">
                                                                                    @endif
                                                                                            ...
                                                                                            @foreach(json_decode($small_product->colors) as $k_img => $small_color)
                                                                                                ...
                                                                                                <li>
                                                                                                    ...
                                                                                                    <label
                                                                                                        ...
                                                                                                        data-target="{{$small_product->id}}_{{$k_img+1}}"
                                                                                                        for="{{$small_product->id}}_{{$k_img+1}}-color-{{$small_color}}"
                                                                                                        class="color-changer"
                                                                                                        data-toggle="tooltip"
                                    ...
                                    <div
                                        ...
                                        <div class="row">
                                            <div
                                                class="col-xxl-11 col-xl-11 col-md-11 col-sm-11 col-11 product_container_side m-auto p-0"
                                                ...
                                                <a href="#" class="">
                                                    ...
                                                    <div class="featured-product-title p-3">
                                                        ...
                                                        <span
                                                            class="bold">{{\App\CPU\translate('recent_side_cont')}}</span>
                                                    </div>
        ...
        @if (isset($flash_deals))
            ...
            <section class="overflow-hidden" dir="rtl">
                <div class="container">
                    <div
                        class="flash-deal-view-all-web row d-lg-flex justify-content-{{Session::get('direction') === "rtl" ? 'start' : 'end'}}"
...
{{--                {{$k_m}}<br>--}}
{{--                {{$main->name}} <br>--}}
{{--                {{$porduct_d->first() ? $porduct_d->first()->count() : 'معندوش اصلا'}} <br>--}}
                        ...
                        @if($main->childes->count() > 0)
                            <section class="featured_subs" dir="rtl">
                                <div class="container" style="">
                                    <div class="row" dir="{{session('direction')}}">
                                        <div class="col-xxl-6 col-xl-6 col-md-6 col-sm-12 col-12">
                                            <h4 class="main_title  bold s_25 mt-5 mr-5">
                                                {{$main->name}}
                                            </h4>
                                                    ...
                                                    @foreach($main->childes as $sub)
                                                        <div class=" featured_sub_cat m-auto text-center">
                                                            <a href="{{route('home')}}/products?id={{$sub->id}}&data_from=category&page=1">
                                                                <img src="{{asset('storage/category/'. $sub->icon)}}"
                                                                     alt="">
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <div class=" row">
                                                                                                ...
                                                                                                <div
                                                                                                    class="col-lg-12 col-md-12  col-12">
                                                                                                    <a href="{{route('product', $small_product->slug)}}">
                                                                                                        <h4 class="s_16 primary_color bold pt-3">
                                                                                                            {{$small_product->name}}
                                                                                                        </h4></a>
                                                                                                </div>
                                                    ...
                                                    @if($main->banners->where('banner_type', 'Main Section Banner') != null && $main->banners->where('banner_type', 'Main Section Banner')->count() > 0)
                                                        ...
                                                        <div class="row">
                                                            <div
                                                                ...
                                                                <a href="{{$main->banners->where('banner_type', 'Main Section Banner')->first()->url}}"
                                                                   class="">

                                                                    <div class="featured-product-title p-3">
                                                                        <h4 class="bold mb-1">{{$main->banners->where('banner_type', 'Main Section Banner')->first()->title}}</h4>
                                                                        <span
                                                                            class="bold">{{$main->banners->where('banner_type', 'Main Section Banner')->first()->description}}</span>
                                                                    </div>
                                                ...
                                                <div class="owl-carousel owl-theme footer_cat_banners" dir="ltr">
                                                    @foreach($main->banners->where('banner_type', 'Footer Banner') as $footer_cat_banner)
                                                        <div
                                                            ...
                                                            <div class="row">
                                                                <div
                                                                    class="col-xxl-12 col-xl-12 col-md-12 col-sm-12 col-12 my-2">
                                                                    <div class="large-offer">
                                                                        <img
                                                                            src="{{asset('storage/banner/'. $footer_cat_banner->photo)}}"
                ...
                @elseif($k_m == 2)
                                            ...
                                            <div class="col-xxl-12 col-xl-12 col-md-12 col-sm-12 col-12 mt-5  pt-3">
                                                <div class="owl-carousel owl-theme main_products_banners" dir="ltr">
                                                    @foreach($main_products_banners as $main_products_banner)
                                                        <div
                                                            class="item custom-product-banner_div position-relative">
                                                            <div style="    width: 100%;
                                                        height: 100%;
                                                        position: absolute;
                                                        z-index: 100;
                                                        ...
                                                        border-radius: 5px;"></div>
                                                            <img
                                                                src="{{asset('storage/banner/'. $main_products_banner->photo)}}"
                                                                alt="" style="border-radius: 5px;max-height: 340px">
                                                            <div class="banner-details" dir="rtl">
                                                                <h4 class="bold s_30">
                                                                    {{$main_products_banner->title}}
                                                                </h4>
                                                                <span class="bold">
                                                    {{$main_products_banner->description}}
                                                    </span>
                                                                <div>
                                                                    <div class="price d-inline-block">
                                                                    <span
                                                                        class="num_fam primary_color pl-3 s_30">{{\App\CPU\Helpers::currency_converter($main_products_banner->product->unit_price)}}</span>
                                                                    </div>
                                                                    <div class="redirect_btn  d-inline-block mt-2 mr-3">
                                                                        <a href="{{$main_products_banner->url}}"
                                                                           class="btn btn-sm btn-custom bold">
                                                                            {{\App\CPU\translate('Shop Now')}}
                                                                        </a>
                                                                    </div>
                    ...
                    @if(isset($featured_deals))
                        <section class="featured_deal rtl">
                            <div class="container">
                                <div class="row __featured-deal-wrap"
                            ...
                            @foreach($footer_products_banners as $footer_products_banner)
                                <div
                                    ...
                                    <div style="    width: 100%;
                                                        ...
                                                        background: rgba(0,0,0,0.1);
                                                        border-radius: 5px;"></div>
                                    <img src="{{asset('storage/banner/'. $footer_products_banner->photo)}}" alt=""
                                         style="border-radius: 5px;max-height: 340px">
                                    <div class="banner-details" dir="rtl">
                                        <h4 class="bold s_30">
                                            {{$footer_products_banner->title}}
                                        </h4>
                                        <span class="bold">
                                                    {{$footer_products_banner->description}}
                                                    </span>
                                        <div>
                                            <div class="price d-inline-block">
                                                <span
                                                    class="num_fam primary_color pl-3 s_30">{{\App\CPU\Helpers::currency_converter($footer_products_banner->product->unit_price)}}</span>
                                            </div>
                                            <div class="redirect_btn  d-inline-block mt-2 mr-3">
                                                <a href="{{$footer_products_banner->url}}"
                                                   class="btn btn-sm btn-custom bold">
                                                    {{\App\CPU\translate('Shop Now')}}
                                                </a>
                                            </div>
                                ...
                                @foreach($brands as $brand)
                                    <div class="m-auto pb-3">
                                        <a href="javascript:void(0);">
                                            <img style="margin:auto;height: 200px;width: 200px"
                    ...
                    <div class="row counts_row">
                        @if(isset($all_cats) && $all_cats->count() > 0)
                            @foreach($all_cats as $cat)
                                ...
                                <div class="w_11_ mb-3">
                                    <h5 class="bold s_17  mb-1" style="color: #000">
                                        {{$cat->name}}
                                    </h5>
                                    <span
                                        class="num_fam bold s_13 second_color count_item">( {{$porducts_count . ' '.\App\CPU\translate('single_product').' )'}}</span>
                                </div>
                            @endforeach
                        @endif

                        <div class="w_11_ mb-3">
                            <h5 class="bold s_17 primary_color mb-1">
                                {{\App\CPU\translate('top sell')}}
                            </h5>
                            <span
                                class="num_fam bold s_13 second_color count_item">({{$bestSellProduct->count(). ' '.\App\CPU\translate('single_product').' )'}}</span>
                        </div>
        ...
        <section class="beauty_vendors container py-4 mt-5">
            ...
            <div class="{{session('direction') == 'rtl' ? 'text-right' : 'text-left'}}  vendors_list"
                 dir="{{session('direction')}}">
                <a href="javascript:void(0);" class="bold primary_color s_18">
                    {{\App\CPU\translate('Products From USA')}}
                </a>
                <span class="bold px-1">-</span>
                <a href="javascript:void(0);" class="bold primary_color s_18">
                    {{\App\CPU\translate('Products From Japan')}}
                </a>
                <span class="bold px-1">-</span>
                <a href="javascript:void(0);" class="bold primary_color s_18">
                    {{\App\CPU\translate('Products From UK')}}
                </a>
                <span class="bold px-1">-</span>
                <a href="javascript:void(0);" class="bold primary_color s_18">
                    {{\App\CPU\translate('Products From Hong Kong')}}
                </a>
                <span class="bold px-1">-</span>
                <a href="javascript:void(0);" class="bold primary_color s_18">
                    {{\App\CPU\translate('Products From korea')}}
                </a>
                <span class="bold px-1">-</span>
                <a href="javascript:void(0);" class="bold primary_color s_18">
