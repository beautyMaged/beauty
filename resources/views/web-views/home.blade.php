                        ...
                        <div class="col-xxl-11 col-xl-11 col-md-11 col-sm-12 col-12 m-auto pt-1">
                            <div class="owl-carousel owl-theme featured_cats1 mains" dir="ltr" data-items="10">
                                @foreach($main_cats as $main_cat)
                                    <div class=" featured_sub_cat  text-center d-flex justify-content-center align-items-center">
                                        <a href="{{route('home')}}/products?id={{$main_cat->id}}&data_from=category&page=1" class="">
                                            <img src="{{asset('storage/category/'. $main_cat->icon)}}" alt="" class="img-fluid" style="border-radius:50%;width:120px;height:120px">
                                            <h5 class="mt-1 bold sub_cat_head primary_color"> {{$main_cat->name}} </h5>
                                        </a>
                                    </div>
                                @endforeach
                            </div>
                                    ...
                                    @foreach($all_cats as $cat)
                                        ...
                                        @php($porducts_count = $porduct_d->whereIn('id', $caro_products_ids)->count())
                                                <div class="pricingTable yellow" style="padding: 8px 4px">
                                                    <div class="pricingTable-header">
                                                        <div class="price-value"><span class="duration" style="font-size: 10px;"> {{$cat->name}} </span> </div>
                                                    </div>
                                                    <ul class="pricing-content">
                                                        <li> <div class="single_price_item position-relative">
                                                            <h4 class="num_fam bold s_14">  {{$porducts_count }}</h4>
                                                        </div> </li>
                                                    </ul>
                                                </div>
                                    @endforeach
