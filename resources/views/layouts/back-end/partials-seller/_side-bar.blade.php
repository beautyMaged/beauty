                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('seller/orders*') ? 'active' : '' }}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li
                                    class="nav-item {{ Request::is('seller/orders/list/processing') ? 'active' : '' }}">
                                ...
                                <li
                                    class="nav-item {{ Request::is('seller/orders/list/delivered') ? 'active' : '' }}">
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('seller/refund*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:">
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('seller/product*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:">
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('seller/transaction/order-list') || Request::is('seller/transaction/expense-list') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li
                                    class="navbar-vertical-aside-has-menu {{ Request::is('seller/transaction/order-list') || Request::is('seller/transaction/expense-list') || Request::is('seller/transaction/order-history-log*') ? 'active' : '' }}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('seller/report/all-product') || Request::is('seller/report/stock-product-report') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('seller.report.all-product') }}"
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('seller/report/order-report') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('seller/profile*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                        ...
                        @if ($shipping_method == 'sellerwise_shipping')
                            ...
                            <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('seller/delivery-man/add') ? 'active' : '' }}">
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('seller/delivery-man/list') || Request::is('seller/delivery-man/earning-statement*') || Request::is('seller/delivery-man/earning-active-log*') || Request::is('seller/delivery-man/order-wise-earning*') ? 'active' : '' }}">
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('seller/delivery-man/withdraw-list') || Request::is('seller/delivery-man/withdraw-view*') ? 'active' : '' }}">
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('seller/delivery-man/emergency-contact/') ? 'active' : '' }}">
                                        <a class="nav-link "
                                            href="{{ route('seller.delivery-man.emergency-contact.index') }}"
                                            title="{{ \App\CPU\translate('withdraws') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span
