                ...
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @if (\App\CPU\Helpers::module_permission_check('product_management'))
                            ...
                            <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/sub-sub-sub-category/view') ? 'active' : '' }}">
                        ...
                        @if (\App\CPU\Helpers::module_permission_check('promotion_management'))
                            ...
                            <li
                                class="nav-item {{ Request::is('admin/banner*') || Request::is('admin/home-banner-settings*') || Request::is('admin/coupon*') || Request::is('admin/notification*') || Request::is('admin/deal*') ? 'scroll-here' : '' }}">
                                <small class="nav-subtitle"
                        ...
                        @if (\App\CPU\Helpers::module_permission_check('user_section'))
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li class="nav-item {{ Request::is('admin/reviews*') ? 'active' : '' }}">
                                        <a class="nav-link" href="{{ route('admin.reviews.list') }}"
                                            title="{{ \App\CPU\translate('Customer Reviews') }}">
                                            {{-- Edited --}}
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span
                                                class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                            ...
                            <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/sellers/seller-commission-list') ? 'active' : '' }}">
