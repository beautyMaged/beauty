            ...
            <div class="card __card cart_information mb-3">
                ...
                <td>
                    <div class="num_fam">
                        ...
                        <input class="__cart-input num_fam" type="number" name="quantity[{{ $cartItem['id'] }}]"
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-12 text-right">
                ...
                {{--                        </label>--}}
                <label for="phoneLabel" class="form-label input-label bold pr-3">{{\App\CPU\translate('order_note')}}
                    <span class="input-label-secondary">({{\App\CPU\translate('Optional')}})</span>
                </label>
...
<div class="d-flex btn-full-max-sm align-items-center __gap-6px flex-wrap justify-content-between cart_btns" dir="rtl">
...
<aside class="col-lg-4 pt-4 pt-lg-2">
    @if(!auth('customer')->check())
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist"
            ...
            <li class="nav-item" role="presentation">
                <a class="nav-link active primary_color bold" id="quick_order_tab" data-toggle="tab" href="#quick_order"
                   role="tab" aria-controls="quick_order" aria-selected="true">{{\App\CPU\translate('Safe Payment')}}</a>
            </li>
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane row text-right px-2 fade show active" id="quick_order" role="tabpanel"
                ...
                <div class="form-group col-lg-12 col-md-12 col-12 col-sm-12 mb-0 pb-0">
                    ...
                    <input type="text" value="{{old('contact_person_name')}}" onkeyup='saveValue(this);' class="form-control" id="contact_person_name" name="contact_person_name" placeholder="ادخل الإسم بالكامل">
                </div>
                <div class="form-group col-lg-12 col-md-12 col-12 col-sm-12 mb-0 pb-0">
                    <label for="person_email" class="bold s_16">البريد الإلكتروني</label>
                    <input type="email" value="{{old('person_email')}}"  onkeyup='saveValue(this);' class="form-control" id="person_email" name="person_email" placeholder="ادخل البريد الإلكتروني" required>
                </div>
                <div class="form-group col-lg-12 col-md-12 col-12 col-sm-12 mb-0 pb-0">
                    <label for="order_phone" class="bold s_16">رقم الهاتف</label>
                    <input type="text" value="{{old('order_phone')}}"  onkeyup='saveValue(this);' class="form-control" id="order_phone" name="order_phone" placeholder="ادخل رقم الهاتف">
                </div>
                <div class="col-lg-6 col-md-6 col-12 d-inline-block" style="max-width: calc(50% - 5px)!important;">
                ...
                <div class="form-group col-lg-12 col-md-12 col-12 col-sm-12 mb-0 pb-0 d-none">
                    ...
                    <input type="text" class="form-control" id="zip" value="11011" name="zip" placeholder="ادخل الرمز البريدي">
                </div>

                <div class="form-group col-lg-12 col-md-12 col-12 col-sm-12 mb-0 pb-0">
                    <label for="address" class="bold s_16"  data-toggle="modal" data-target="#location_modal" >العنوان الحالي &nbsp;&nbsp;<span><i
                    ...
                    @if(auth('customer')->check() && auth('customer')->user()->street_address != null)
                        <textarea class="form-control" id="address" name="address" placeholder="ادخل العنوان">{{auth('customer')->user()->street_address}}</textarea>
                    @elseif(Session::has('current_location'))
                        <textarea class="form-control" id="address" name="address" placeholder="ادخل العنوان">{{Session::get('current_location')}}</textarea>
                    @else
                        <textarea class="form-control" id="address" name="address" placeholder="ادخل العنوان"></textarea>
                    @endif
                </div>
            ...
            <div class="tab-pane row text-right px-2 fade" id="login" role="tabpanel" aria-labelledby="login-tab">
                <form action="{{route('customer.auth.login')}}" method="post" id="form-id" class="row needs-validation mt-2">
                    @csrf
                    <div class="form-group col-lg-12 col-md-12 col-12 col-sm-12 mb-0 pb-0">
