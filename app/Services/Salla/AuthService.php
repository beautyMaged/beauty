...
class AuthService
{
    ...
    public function __construct()
    {
        $this->provider = new Salla([
            ...
            'redirectUri'  => $this->isEasyMode() ? null : route('seller.salla.oauth.callback'), // the url for current page in your service
        ]);
    }
    ...
    public function forToken(SallaOauthToken $token)
    {
        $this->token = $token;
        return $this;
    }
